...
dag = DAG('training_pipeline_k8_multi',
...
with dag:
    ...
    training_random_forest = SparkSubmitOperator(
        task_id='training_random_forest',
        name='training_random_forest',
        conn_id='spark_k8s',
        proxy_user='root',
        application='abfss://py-files@REDACTED.dfs.core.windows.net/main_kubernetes.py',
        files='abfss://py-files@REDACTED.dfs.core.windows.net/configuration/config_training_random_forest.yml',
        py_files='abfss://py-files@REDACTED.dfs.core.windows.net/jobs.zip',
        conf=default_conf_spark,
        execution_timeout=timedelta(minutes=120),
        dag=dag)
    ...
    evaluation = SparkSubmitOperator(
        ...
        proxy_user='root',
        application='abfss://py-files@REDACTED.dfs.core.windows.net/main_kubernetes.py',
        files='abfss://py-files@REDACTED.dfs.core.windows.net/configuration/config_evaluator_rfc_gbt.yml',
        py_files='abfss://py-files@REDACTED.dfs.core.windows.net/jobs.zip',
        conf=default_conf_spark,
        execution_timeout=timedelta(minutes=120),
        dag=dag)

extraction_training >> processing_training >> [
    training_gradient_boosted_trees, training_random_forest] >> evaluation
