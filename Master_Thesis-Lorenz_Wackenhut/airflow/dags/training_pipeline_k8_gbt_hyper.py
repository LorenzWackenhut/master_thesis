...
dag = DAG('training_pipeline_k8_gbt_hyper',
...
with dag:
    ...
    training_gradient_boosted_trees_hyper = SparkSubmitOperator(
...
extraction_training >> processing_training >> training_gradient_boosted_trees_hyper >> evaluation
